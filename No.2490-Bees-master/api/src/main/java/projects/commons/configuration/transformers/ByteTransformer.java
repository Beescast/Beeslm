package projects.commons.configuration.transformers;

import java.lang.reflect.Field;

import projects.commons.utils.config.PropertyTransformer;
import projects.commons.utils.config.TransformationException;

/**
 * Transforms String to Byte. String can be in decimal or hex format.
 * {@link com.games.commons.configuration.TransformationException} will be thrown if something goes wrong
 *
 * @author SoulKeeper
 */
