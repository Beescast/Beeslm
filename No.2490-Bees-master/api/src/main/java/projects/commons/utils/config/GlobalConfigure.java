...
import projects.commons.PropertiesUtils;
...
public class GlobalConfigure {
     ...
     */
    protected static final Logger log = Logger.getLogger(GlobalConfigure.class);
    ...
    public void init() {
        try {
            ...
            ConfigurableProcessor.process(GlobalConfigure.class, props);
