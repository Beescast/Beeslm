<?php
   ...
   $app_id = "101356049"; 
   //应用的APPKEY 
   $app_secret = "3decc0b185f1a0ad4b9db9e8ad63bd3c"; 
   //【成功授权】后的回调地址，即此地址在腾讯的信息中有储存 
   $my_url = "http://admin.beeslm.com/login/QQLogin.php"; 
   ...
   { 
    ...
    header("Location: http://beeslm.com/redirectQQLogin.html?openid=".$user->openid);
