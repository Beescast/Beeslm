            ...
            <div class="col-lg-12">
                ...
                <div id="printArea" class="box">
                     ...
                     <div class="box-title">
                        ...
                        <td></td>
                        <td></td>
                        <td width="" style="text-align:center"><a href="noticeAdd.php?action=modify&id=123" class="btn btn-primary btn-sm" >已通过</a><span>  </span><a href="noticeAdd.php?action=modify&id=123" class="btn btn-primary btn-sm" >不通过</a>
