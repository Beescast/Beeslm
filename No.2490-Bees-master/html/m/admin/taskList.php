            ...
            <div class="col-lg-12">
                ...
                <div id="printArea" class="box">
                     ...
                     <div class="box-title">
                        ...
                        <td></td>
                        <td></td>
                        <td width="" style="text-align:center"><a href="noticeAdd.php?action=modify&id=123" class="btn btn-primary btn-sm" >取消中标</a><span>  </span><a href="noticeAdd.php?action=modify&id=123" class="btn btn-primary btn-sm" >审核 </a>
                        <td></td>   
                        <td></td>  
                        <td></td>  
                        <td></td>  
