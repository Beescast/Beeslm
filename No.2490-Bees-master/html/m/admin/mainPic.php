 ...
 <!-- wrapper -->
    ...
    <form class="form-inline" name="" method="get" enctype="multipart/form-data" action="" role="form">
        ...
        <a href="#" class="btn btn-info" onclick="searchs()">查询</a>
         <a href="mainPicAdd.php?action=add" class="btn btn-primary btn-sm" >新增图片</a> 
            ...
            <div class="col-lg-12">
                ...
                <div id="printArea" class="box">
                     ...
                     <div class="box-title">
                        ...
                        <td></td>
                        <td></td>
                        <td width="" style="text-align:center"><a href="mainPicAdd.php?action=modify&id=123" class="btn btn-primary btn-sm" >修改</a>
