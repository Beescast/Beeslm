 ...
 <!-- wrapper -->
    ...
    <div class="box">
        ...
        <div class="row">
            ...
            <div class="form-group" id="" >
            <label for="mobile" class="col-sm-2 control-label">种类与价格一</label>
            <div class="col-sm-3">
            ...
            <div class="col-sm-4" style="padding-top:7px;"></div>
             ...
             <div class="form-group" id="" >
            <label for="mobile" class="col-sm-2 control-label">种类与价格二</label>
            <div class="col-sm-3">
            ...
            <div class="col-sm-4" style="padding-top:7px;"></div>
             ...
             <div class="form-group" id="" >
            <label for="mobile" class="col-sm-2 control-label">种类与价格三</label>
            <div class="col-sm-3">
