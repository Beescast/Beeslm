...
<script src="maniac/js/plugins/datatables/jquery.dataTables.js" type="text/javascript"></script>
 <!-- wrapper -->
    ...
    <form class="form-inline" name="" method="get" enctype="multipart/form-data" action="" role="form">
        ...
        <div class="form-group">
        <label>时间区间</label>
        <input class="form-control" type="text" style="width:180px;" value="" size="35" placeholder="" data-inputmask="'mask': ''" name="shop_name" autocomplete="off" class="form-control Wdate" onclick="WdatePicker({dateFmt:'dd'})" style="height:auto;width:120px;">
        </div>
        <div class="form-group">
        <label>至</label>
        <input class="form-control" type="text" style="width:180px;" value="" size="35" placeholder="" data-inputmask="'mask': ''" name="shop_name" autocomplete="off" class="form-control Wdate" onclick="WdatePicker({dateFmt:'dd'})" style="height:auto;width:120px;">
            ...
            <div class="col-lg-12">
                ...
                <div id="printArea" class="box">
                     ...
                     <div class="box-title">
                        ...
                        <td>500</td>
                        <td>100</td>
                        <td><a href="noticeAdd.php?action=modify&id=123" class="btn btn-primary btn-sm" >查看 </a></td>
